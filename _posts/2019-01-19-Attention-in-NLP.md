...
Encoder-Decoder 구조에서 가장 중요한 부분은 input sequence를 어떻게 vector화할 것이냐는 문제입니다. 특히 NLP에서는 input sequence이가 dynamic할 구조일 때가 많으므로, 이를 고정된 길이의 벡터로 만들면서 문제가 발생하는 경우가 많습니다. 즉, "안녕" 이라는 문장이나 "오늘 날씨는 좋던데 미세먼지는 심하니깐 나갈 때 마스크 꼭 쓰고 나가렴!" 이라는 문장이 담고 있는 정보의 양이 매우 다름에도 encoder-decoder구조에서는 같은 길이의 vector로 바꿔야 하죠. 
...
![copynet](../images/2019-01/190119_copynet.png)
...
### Hierachical Structures (Yang et al. 2016)
...
![self_attention](../images/2019-01/190119_self_attention.png)
...
![multi_head_attention](../images/2019-01/190119_multi_head_attention.png)
...
![transformer](../images/2019-01/190119_transformer.png)
